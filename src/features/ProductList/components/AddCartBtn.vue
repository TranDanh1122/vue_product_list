        ...
        <transition name="flip" mode="out-in">
            <div>
                ...
                <div v-if="cartItem"
                    ...
                    <button @click="cartStore.changeQty(cartItem.product.id, cartItem.qty - 1)"
                        aria-label="decrement cart item"
                        class="size-4.5 border border-white flex justify-center items-center rounded-full">
                        <img src="/assets/images/icon-decrement-quantity.svg" alt="decrement cart item"
                            class="object-cover">
                    </button>
                    <input v-model="qty"
                    ...
                    <button @click="cartStore.changeQty(cartItem.product.id, cartItem.qty + 1)"
                        ...
                        class="size-4.5 border border-white flex justify-center items-center rounded-full">
                        <img src="/assets/images/icon-increment-quantity.svg" alt="increment cart item"
                            class="object-cover">
                    </button>
                </div>
            </div>
